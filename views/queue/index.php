...
<div class="queue-index">
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [ 'attribute' => 'owner.Description', 'label'=>'Owner Description', 'visible' => \Yii::$app->user->identity->isAdmin,],
            //[ 'attribute' => 'OwnerDescription','value' => function ($model, $key, $index, $column) { return $model->owner->Description;},'visible' => \Yii::$app->user->identity->isAdmin,],
